...
CGFloat const COLLECTION_VIEW_HEIGHT = 160.0;
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
        ...
        self.textfieldPlaceholderTextColor = [UIColor colorWithRed:(226/255.0) green:106/255.0 blue:106/255.0 alpha:1];;
        self.textfieldRegularTextColor =[UIColor colorWithRed:(226/255.0) green:106/255.0 blue:106/255.0 alpha:1];
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    [_chosenTagCollectionView setScrollEnabled:true];
    [_availableTagCollectionView setScrollEnabled:true];
}
...
- (void)setChosenTagCollectionViewHidden:(BOOL)hidden {
    if (hidden) {
        ...
        self.chosenTagCollectionViewHeightConstraint.constant = 53;
    }
