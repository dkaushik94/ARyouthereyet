...
open class CircularSlider: UIView {
    ...
    fileprivate func configure() {
        ...
        self.textfield.textColor = UIColor(red: 84/255.0, green: 250/255.0, blue: 219/255.0, alpha: 1)

//        self.divisaLabel.textColor = UIColor(red: 1/255.0, green: 50/255.0 , blue: 67/255.0, alpha: 1)
        
         self.divisaLabel.textColor = UIColor(red: 84/255.0, green: 250/255.0, blue: 219/255.0, alpha: 1)
